...
@section('container')
  <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
    <h1 class="h2 block">Edit Post</h1>
  </div>
  ...
  <div class="col-md-12">
    <form method="POST" action="/dashboard/posts/{{ $post->slug }}" class="mb-5" enctype="multipart/form-data">
      ...
      <div class="mb-3">
        ...
        @if ($post->image)
          <img src="{{ asset('storage/' . $post->image) }}" alt="preview image" class="img-preview img-fluid my-3 col-sm-5 d-block">
        @else
      ...
      <div class="mb-3">
        ...
        @enderror
        <input class="form-control" id="body" name="body" type="hidden" value="{{ old('body', $post->body) }}"> {{-- type="text" dihapus --}}
  ...
  {{-- <script> jujur yang ini gabisa dipake
  ...
  <script> // dapat dari komentar video 18.create post form
    const title = document.querySelector("#title");
    const slug = document.querySelector("#slug");
